    ...
    export default {
        ...
        data() {
            return {
                students: [],
                program: '',
                program_banner: '/imgs/no-img_700_light.png',
                program_reps: {},
                nextStudent: 1,
                ItemIsLoading: false,
                query_interval: 14,
                ...
                params: {
                    ...
                    gradclass: this.$route.params.gradclass,
        ...
        created() {
            ...
            get('http://gmkyrbuk.cloudapp.net/api/yearbook/program/' + this.params.institution + '/' + this.params.gradclass + '/' + this.params.program)
                .then((res) => {
                    this.SidebarLoading = false;
                    this.program = res.data.program;
                    this.pageTitle = this.program + ' | Yrbuk';
        ...
        methods: {
            ...
            loadStudents(query_from, query_to) {
                if (!this.ItemIsEmpty) {
                    ...
                    get('http://gmkyrbuk.cloudapp.net/api/yearbook/program/users/' + this.params.institution + '/' + this.params.gradclass + '/' +
                            this.params.program + '?from=' + query_from + '&to=' + query_to)
                        .then((res) => {
